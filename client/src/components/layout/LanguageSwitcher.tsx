...
export function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1 rounded-lg px-2 py-1.5 text-xs font-semibold text-poke-gray-500 hover:bg-poke-gray-100 hover:text-poke-red dark:hover:bg-poke-gray-800 transition-colors"
    >
