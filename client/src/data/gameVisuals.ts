...
export const GAME_VISUALS: Record<string, GameVisual> = {
  ...
  firered: { speciesId: 6, from: '#FF5722', to: '#BF360C', accent: '#FFAB91' },
  leafgreen: { speciesId: 3, from: '#66BB6A', to: '#2E7D32', accent: '#A5D6A7' },
  ...
  heartgold: { speciesId: 250, from: '#FFD54F', to: '#F57F17', accent: '#FFE082' },
  soulsilver: { speciesId: 249, from: '#B0BEC5', to: '#455A64', accent: '#ECEFF1' },
  black: { speciesId: 643, from: '#212121', to: '#000000', accent: '#616161' },
  white: { speciesId: 644, from: '#FAFAFA', to: '#BDBDBD', accent: '#FFFFFF' },
  'black-2': { speciesId: 646, from: '#37474F', to: '#102027', accent: '#78909C' },
  'white-2': { speciesId: 646, from: '#ECEFF1', to: '#90A4AE', accent: '#FFFFFF' },
  x: { speciesId: 716, from: '#E91E63', to: '#880E4F', accent: '#F48FB1' },
  y: { speciesId: 717, from: '#E53935', to: '#B71C1C', accent: '#EF9A9A' },
  'omega-ruby': { speciesId: 383, from: '#D32F2F', to: '#7F0000', accent: '#EF5350' },
  'alpha-sapphire': { speciesId: 382, from: '#1976D2', to: '#0D47A1', accent: '#64B5F6' },
  sun: { speciesId: 785, from: '#FF9800', to: '#E65100', accent: '#FFB74D' },
  moon: { speciesId: 786, from: '#7E57C2', to: '#4527A0', accent: '#B39DDB' },
  'ultra-sun': { speciesId: 800, from: '#FFB300', to: '#FF6F00', accent: '#FFD54F' },
  'ultra-moon': { speciesId: 800, from: '#5E35B1', to: '#311B92', accent: '#9575CD' },
  'lets-go-pikachu': { speciesId: 25, from: '#FFEB3B', to: '#F9A825', accent: '#FFF59D' },
  'lets-go-eevee': { speciesId: 133, from: '#A1887F', to: '#6D4C41', accent: '#D7CCC8' },
  sword: { speciesId: 888, from: '#1565C0', to: '#0D47A1', accent: '#64B5F6' },
  shield: { speciesId: 889, from: '#C62828', to: '#8E0000', accent: '#EF5350' },
  'brilliant-diamond': { speciesId: 483, from: '#81D4FA', to: '#0288D1', accent: '#E1F5FE' },
  'shining-pearl': { speciesId: 484, from: '#F8BBD0', to: '#EC407A', accent: '#FCE4EC' },
  ...
  'legends-za': { speciesId: 150, from: '#616161', to: '#212121', accent: '#BDBDBD' },
};
