...
export function Footer() {
  ...
  return (
    <footer className="mt-12 border-t border-poke-gray-200 dark:border-poke-gray-800 py-8">
      <div className="mx-auto w-full max-w-[1600px] space-y-4 px-4 text-sm text-poke-gray-500 lg:px-8">
