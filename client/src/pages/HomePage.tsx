...
export function HomePage() {
  ...
  return (
    <div className="space-y-12">
      <section className="relative overflow-hidden rounded-3xl border border-poke-gray-200 dark:border-poke-gray-800 bg-white dark:bg-poke-gray-800 p-8 md:p-12">
        ...
        <div className="relative max-w-3xl space-y-6">
          ...
          <p className="text-lg text-poke-gray-500 leading-relaxed">
            {t('home.subtitle')}
          </p>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <Link to="/cards" className="glass-panel card-hover group p-8 block">
          <SearchIcon className="h-10 w-10 text-poke-red mb-4" />
          <h2 className="text-2xl font-bold mb-2 group-hover:text-poke-red transition-colors">{t('home.galleryTitle')}</h2>
        ...
        <Link to={user ? '/collection' : '/login'} className="glass-panel card-hover group p-8 block border-2 border-poke-red/15">
          <CollectionIcon className="h-10 w-10 text-poke-black dark:text-poke-white mb-4" />
          <h2 className="text-2xl font-bold mb-2">{t('home.albumTitle')}</h2>
          <p className="text-poke-gray-500 leading-relaxed">
            {t('home.albumDesc')}
          </p>
